import { Component, OnInit, OnDestroy, ViewChild, ViewEncapsulation, NgModule  } from '@angular/core';
...
// @NgModule({imports: [FakeDbService] })
export class SnapshotsComponent implements OnInit, OnDestroy {
  
  // @param {CoreConfigService} _coreConfigService;
  // @param {SnapshotsService }  _snapshotsservice;
  ...
  //  * @param {SnapshotsService }  _snapshotsservice;
  //  */
  constructor(private _snapshotsservice:SnapshotsService , private _coreConfigService: CoreConfigService,private modalService: NgbModal) { 
  ...
  ngOnInit() {
    this._snapshotsservice.onCardAnalyticsChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
      this.data = response;
    });
